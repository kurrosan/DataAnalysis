...
### Цель работы: Построение и оценка модели машинного обучения (Random Forest) для классификации транзакций с кредитными картами с целью выявления мошеннических операций.   
...
Данный код создает предсказания с использованиемbest_model для тестового набора данных X_test. Затем результаты предсказаний сохраняются в формате CSV в файл с именем 'submission.csv'. Файл 'submission.csv' содержит два столбца: 'Id', представляющий идентификаторы тестовых данных, и 'PredictedLabel', содержащий предсказанные метки для соответствующих данных.
```python
...
![image](https://github.com/kurrosan/DataAnalysis/assets/120035199/72f1fa63-0063-4c4f-a7d2-f0144656b957)
